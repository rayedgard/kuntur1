...
MySQL - 5.0.51b-community-nt-log : Database - kuntur
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`kuntur` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `eventos`(`id`,`nombre`,`linkeventos`,`imagen`,`descripcion`,`fecha`,`eliminar`,`idioma`) values (1,'Paucartambo','http://peru21.pe/actualidad/machu-picchu-restriccion-acceso-buses-ciudadela-no-afecta-visitas-2165977','paucartambo.jpg','<p><span>A cuatro horas del Cusco, en la localidad dePaucartambo, miles de creyentes veneran en sendas fiestas a la Virgen del Carmen, llamada localmente Mamacha Carmen, patrona de los mestizos. La reuni&oacute;n que da inicio a estos d&iacute;as de fiesta se realiza en la Plaza Mayor, donde las bandas de m&uacute;sicos tocan sus instrumentos, mientras que coros ricamente ataviados cantan en quechua, dando inicio a ingeniosas coreograf&iacute;as que representan pasajes de la historia del Per&uacute;. Durante cinco d&iacute;as se presentan comparsas de distintos disfraces (Doctorcitos, Waca Waca, Sarjas) que desfilan en procesi&oacute;n acompa&ntilde;ando a la &laquo;Mamacha&raquo; durante todo su recorrido por la Plaza de Armas, el atrio del templo y las calles del pueblo. El d&iacute;a central la Virgen es conducida en procesi&oacute;n para bendecir a los asistentes y alejar a los demonios. Los danzantes realizan gimn&aacute;sticas y arriesgadas pruebas sobre los techos de las casas, mostrando sus atuendos de modas incaicas y coloniales. Al finalizar la procesi&oacute;n se realiza una guerra contra los demonios, de la cual los fieles salen triunfantes. Finalmente la comitiva termina su trayecto en el cementerio para rendirle un homenaje a \"las almas\".</span></p>','2015-07-15',0,0);
insert  into `eventos`(`id`,`nombre`,`linkeventos`,`imagen`,`descripcion`,`fecha`,`eliminar`,`idioma`) values (2,'Fiesta Quillabamba','http://peru21.pe/actualidad/machu-picchu-restriccion-acceso-buses-ciudadela-no-afecta-visitas-2165977','quillabamba.jpg','<p><span>Provincia de La Convenci&oacute;n, Distrito de Santa Ana Cusco</span><br /><span>Esta es la celebraci&oacute;n del aniversario de la provincia de La Convenci&oacute;n cuya capital es&nbsp; Quillabamba. Cada a&ntilde;o, una Reina del Caf&eacute; &oacute; &ldquo;Miss Quillabamba&rdquo; es elegida. Tambi&eacute;n hay pelea de gallos, torneos, competiciones de motocross, y la Feria de Cocla, que cuenta con un festival de m&uacute;sica con artistas nacionales e internacionales.</span></p>','2015-07-25',0,0),(3,'Pachamama Raymi','http://peru21.pe/actualidad/machu-picchu-restriccion-acceso-buses-ciudadela-no-afecta-visitas-2165977','pachamama.jpg','<p><span>Todo el departamento de Cusco.</span><br /><span>En este d&iacute;a, los siguientes festivales toman lugar en: Pachamama raymi en el distrito de Ccatca, Wataqallariy en el distrito de Maras, y Kinturaymi en Huasao en el distrito de Oropesa. Este es un ritual andino que adora y rinde tributo a la Pachamama (Madre Tierra) en una ceremonia especial denominada \"pago a la tierra\" con ofrendas de hojas de coca, chicha de jora y semillas de huayruro (semillas de la selva m&iacute;stica). El rito marca el comienzo del A&ntilde;o Nuevo Andino.</span></p>','2015-08-01',0,0);
